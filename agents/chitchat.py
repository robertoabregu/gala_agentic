...
def _fallback_chitchat_response(normalized_question: str, user_name: str = "") -> str:
    ...
    if normalized_question in {"quien sos", "quien eres", "que sos"}:
        return "Soy Gala, el asistente virtual de Banco Galicia."

    if normalized_question in {"como estas", "como andas"}:
        return f"Muy bien{name_part}, gracias. Decime si necesitás ayuda con préstamos o situación crediticia."

    return f"Hola{name_part}. Decime si necesitás ayuda con préstamos o situación crediticia."
...
- Redirigí suavemente hacia consultas sobre préstamos o situación crediticia cuando corresponda.
